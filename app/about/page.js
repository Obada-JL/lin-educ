                ...
                <div className="row">
                  <div className="col-12 col-lg-6 eq-height">
                    <div className="split_section_left">
                      ...
                      <p>
                        Discover our curated courses and interactive learning
                        platform designed to fit your schedule and goals. Join
                        our supportive community and master new skills at your
                        own pace.
                      </p>
            ...
            <div className="row">
              <div className="col">
                <div className="section_title_container section_title_container_centered">
                  ...
                  <p>
                    Discover the meaningful impact we've made in empowering
                    learners worldwide.
                  </p>
                </div>
              </div>
            ...
            <div className="row stats_items">
              ...
              <div className="col-xl-3 col-md-6 col-12">
                <div className="stats_item">
                  ...
                  <div className="stats_num">98%</div>
              ...
              <div className="col-xl-3 col-md-6 col-12">
                <div className="stats_item">
                  ...
                  <div className="stats_num">96%</div>
                  <div className="stats_subtitle_2">
                    <p>Since inception</p>
                  </div>
                  <p className="stats_description">
              ...
              <div className="col-xl-3 col-md-6 col-12">
                <div className="stats_item">
                  ...
                  <div className="stats_num">500+</div>
                  <div className="stats_subtitle_2">
              ...
              <div className="col-xl-3 col-md-6 col-12">
                <div className="stats_item">
                  ...
                  <div className="stats_num">95%</div>
                  <div className="stats_subtitle_2">
                ...
                <div className="col">
                    <div className="testimonials_slider_container">
                        <div className="owl-carousel owl-theme testimonials_slider">
                            ...
                            <div className="slider_item">
                                <div className="testimonial d-flex flex-column align-items-center justify-content-center">
                                    <div className="testimonial_rating d-flex flex-row">
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 20 20"><path className="st0" d="M3.8,19.3l1.7-6.9L0,7.8l7.2-0.6L10,0.7l2.8,6.5L20,7.8l-5.5,4.6l1.7,6.9L10,15.7L3.8,19.3z"/></svg>
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 20 20"><path className="st0" d="M3.8,19.3l1.7-6.9L0,7.8l7.2-0.6L10,0.7l2.8,6.5L20,7.8l-5.5,4.6l1.7,6.9L10,15.7L3.8,19.3z"/></svg>
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 20 20"><path className="st0" d="M3.8,19.3l1.7-6.9L0,7.8l7.2-0.6L10,0.7l2.8,6.5L20,7.8l-5.5,4.6l1.7,6.9L10,15.7L3.8,19.3z"/></svg>
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 20 20"><path className="st0" d="M3.8,19.3l1.7-6.9L0,7.8l7.2-0.6L10,0.7l2.8,6.5L20,7.8l-5.5,4.6l1.7,6.9L10,15.7L3.8,19.3z"/></svg>
                                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 20 20"><path className="st0" d="M3.8,19.3l1.7-6.9L0,7.8l7.2-0.6L10,0.7l2.8,6.5L20,7.8l-5.5,4.6l1.7,6.9L10,15.7L3.8,19.3z"/></svg>
                                    ...
                                    <div className="testimonial_content">
                                        <p>“The courses on this website have been incredibly helpful. I've learned so much and have been able to apply my new knowledge in my job.”</p>
                                    </div>
                                    <div className="testimonial_author d-flex flex-row align-items-center">
                                        <div className="testimonial_author_pic">
                                            <img src="https://placehold.co/64x64" alt="">
                                        </div>
                                        <div className="testimonial_author_info d-flex flex-row align-items-center">
                                            <div>
                                                <div className="testomonial_author_name">Veronica Ricci</div>
                                                <div className="testimonial_author_title">Marketing Manager, ABC Company</div>
                                            </div>
                                            <div>
                                                <img src="https://placehold.co/100x29" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="slider_nav_btn slider_nav_btn_prev blog_slider_prev d-flex flex-row align-items-center justify-content-center trans_200">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="trans_200"><path d="M576-253.85 349.85-480 576-706.15 613.15-669l-189 189 189 189L576-253.85Z"/></svg>
                        </div>
                        ...
                        <div className="slider_nav_btn slider_nav_btn_next blog_slider_next d-flex flex-row align-items-center justify-content-center trans_200">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" className="trans_200"><path d="m535.85-480-189-189L384-706.15 610.15-480 384-253.85 346.85-291l189-189Z"/></svg>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div className="brands">
        <div className="brands_inner">
            <div className="container">
                <div className="row">
                    <div className="col">
                        <div className="brands_flex d-flex flex-row align-items-center">
                            <div className="brands_description d-flex flex-row align-items-center">
                                <p>Our students now work at</p>
                            </div>
                            <div className="marquee_mode">
                                <div className="marquee_content d-flex flex-row align-items-center justify-content-between">
                                    <div className="brand_item"><img src="https://placehold.co/100x29" alt=""></div>
                                    <div className="brand_item"><img src="https://placehold.co/100x29" alt=""></div>
                                    <div className="brand_item"><img src="https://placehold.co/100x29" alt=""></div>
                                    <div className="brand_item"><img src="https://placehold.co/100x29" alt=""></div>
                                    <div className="brand_item"><img src="https://placehold.co/100x29" alt=""></div>
            ...
            <div className="row">
                <div className="col">
                    <div className="section_title_container section_title_container_centered">
                        <div className="section_subtitle">
                            <div className="d-flex flex-row align-items-center">
                                <img src="images/teachers_icon.png" alt="">
                                <span>Expert team</span>
                            </div>
                        </div>
                        <div className="section_title"><h2>Our Teachers</h2></div>
                    </div>
                </div>
            </div>
            <div className="row teachers_row">
                ...
                <div className="col-xl-3 col-md-6 col-12">
                    <div className="teacher">
                        <div className="teacher_pic">
                            ...
                            <div className="teacher_social d-flex flex-column align-items-center justify-content-center trans_300">
                                <div className="social_links_container d-flex flex-row">
                                    <div>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50"><path d="M25,3C12.85,3,3,12.85,3,25c0,11.03,8.125,20.137,18.712,21.728V30.831h-5.443v-5.783h5.443v-3.848 c0-6.371,3.104-9.168,8.399-9.168c2.536,0,3.877,0.188,4.512,0.274v5.048h-3.612c-2.248,0-3.033,2.131-3.033,4.533v3.161h6.588 l-0.894,5.783h-5.694v15.944C38.716,45.318,47,36.137,47,25C47,12.85,37.15,3,25,3z"></path></svg>
                                        </a> 
                                    </div>
                                    <div>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 512 512"><g><polygon points="153.2,135.6 322,377 358.6,377 189.8,135.6"/><path d="M256,20.6C126,20.6,20.6,126,20.6,256S126,491.4,256,491.4S491.4,386,491.4,256S386,20.6,256,20.6z M310.7,394.2 l-73.8-107.4l-92.4,107.4h-23.9l105.7-122.8L120.7,117.6h80.6l69.9,101.7l87.5-101.7h23.9L281.7,234.7h0l109.6,159.5H310.7z"/></g></svg>
                                        </a> 
                                    </div>
                                    <div>
                                        <a href="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 50 50"><path d="M25,2C12.318,2,2,12.317,2,25s10.318,23,23,23s23-10.317,23-23S37.682,2,25,2z M18,35h-4V20h4V35z M16,17 c-1.105,0-2-0.895-2-2c0-1.105,0.895-2,2-2s2,0.895,2,2C18,16.105,17.105,17,16,17z M37,35h-4v-5v-2.5c0-1.925-1.575-3.5-3.5-3.5 S26,25.575,26,27.5V35h-4V20h4v1.816C27.168,20.694,28.752,20,30.5,20c3.59,0,6.5,2.91,6.5,6.5V35z"></path></svg>
                                        </a> 
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="teacher_info d-flex flex-column align-items-center justify-content-center trans_400">
                ...
                <div className="col-xl-3 col-md-6 col-12">
                    <div className="teacher">
                        ...
                        <div className="teacher_info d-flex flex-column align-items-center justify-content-center trans_400">
                            <div className="teacher_name">Tatiana Ivanova</div>
                            <div className="teacher_title">Arts Teacher</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-xl-3 col-md-6 col-12">
                    <div className="teacher">
                        ...
                        <div className="teacher_info d-flex flex-column align-items-center justify-content-center trans_400">
                            <div className="teacher_name">Elijah Kimani</div>
                            <div className="teacher_title">Arts Teacher</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-xl-3 col-md-6 col-12">
                    <div className="teacher">
                        ...
                        <div className="teacher_info d-flex flex-column align-items-center justify-content-center trans_400">
                            <div className="teacher_name">Mateo Fernandez</div>
                            <div className="teacher_title">Arts Teacher</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-xl-3 col-md-6 col-12">
                    <div className="teacher">
                        ...
                        <div className="teacher_info d-flex flex-column align-items-center justify-content-center trans_400">
                            <div className="teacher_name">Mei Chen</div>
                            <div className="teacher_title">Arts Teacher</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-xl-3 col-md-6 col-12">
                    <div className="teacher">
                        ...
                        <div className="teacher_info d-flex flex-column align-items-center justify-content-center trans_400">
                            <div className="teacher_name">Sofia Santos</div>
                            <div className="teacher_title">Arts Teacher</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-xl-3 col-md-6 col-12">
                    <div className="teacher">
                        ...
                        <div className="teacher_info d-flex flex-column align-items-center justify-content-center trans_400">
                            <div className="teacher_name">Wei Cheng</div>
                            <div className="teacher_title">Arts Teacher</div>
                        </div>
                    </div>
                </div>
