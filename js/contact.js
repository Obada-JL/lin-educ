...
export const initializeUI = () => {
  if (typeof window === "undefined") return; // Ensure it runs on the client side
  ...
  $(document).ready(function () {
    ...
    function initHeaderSearch() {
      ...
      $(".header_search_suggestions_container").on(
        "mousedown",
        function (event) {
          event.preventDefault();
        }
    ...
    /* Add the other functions here (initSearchPanel, initCartHover, etc.) */
  });
};
